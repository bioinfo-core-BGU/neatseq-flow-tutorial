...
setup(
    ...
    data_files          = [('TUTORIAL',['Example_WF_conda_env.yaml',
                            ...
                            ('TUTORIAL/Sample_sets',['Samples_from_FTP.nsfs',
                                                     'Samples.nsfs',
                                                     'Samples_conda.nsfs']),
                            ('TUTORIAL/Data',[  'Sample_sets/Sample1.F.fastq.gz',
                                                'Sample_sets/Sample1.R.fastq.gz',
                                                'Sample_sets/Sample1.fasta.gz',
                                                'Sample_sets/Sample2.F.fastq.gz',
                                                'Sample_sets/Sample2.R.fastq.gz',
                                                'Sample_sets/Sample2.fasta.gz',
                                                'Sample_sets/Sample3.F.fastq.gz',
                                                'Sample_sets/Sample3.R.fastq.gz',
                                                'Sample_sets/Sample3.fasta.gz',
